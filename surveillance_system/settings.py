# surveillance_system/settings.py
...
# ALLOWED_HOSTS must contain your Render service URL.
...
# Configuration for Whitenoise to handle static files.
STATIC_URL = 'static/'
...
# settings.py
# CORS Configuration
CORS_ALLOWED_ORIGINS = ["https://wastetr.web.app"]
CORS_ALLOW_CREDENTIALS = False

# This setting allows all origins to make cross-origin requests.
